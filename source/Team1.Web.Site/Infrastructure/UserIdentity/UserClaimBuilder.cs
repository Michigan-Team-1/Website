...
namespace Team1.Web.Site.Infrastructure.UserIdentity
{
    /// <summary>
    ...
    public class UserClaimBuilder : UserClaimModel
    {
        ...
        public UserClaimBuilder(System.Security.Claims.ClaimsPrincipal claimsUser)
        {
            ...
            Email = UserClaimString(JwtRegisteredClaimNames.Sub);

            UserId = UserClaimInt(UserIdClaimType);
            UserIdOriginal = UserClaimInt(JwtRegisteredClaimNames.Sid);
            FirstName = UserClaimString(JwtRegisteredClaimNames.GivenName);
            LastName = UserClaimString(JwtRegisteredClaimNames.FamilyName);
