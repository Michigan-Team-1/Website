...
namespace System.Linq
{
    public static class IEnumerableExtensions
    {
        ...
        /// <returns><see cref="Dictionary{String, Int32}"/> String is property and int is the longest string length.  Null otherwise.</returns>
        ...
        /// <param name="IgnorePropertyList">properties to ignore</param>
        ...
        public static T GetAggregateForAllNumericProperties<T>(this IEnumerable<T> list, AggregateFunction aggregateFunction, String[] IgnorePropertyList = null)
        {
            ...
            // only needs to happen when there are no records
            if (listCount == 0)
            {
        ...
        /// <summary>
        /// Determines if a type is DateTime.  Nullable numeric types are considered DateTime.
        /// </summary>
        /// <remarks>
        /// Boolean is not considered numeric.
        /// </remarks>
        public static bool IsDateTimeType(this Type type)
        {
            ...
            switch (type)
            {
                ...
                case Type _ when type.IsGenericType:
                    ...
                    {
                        return Nullable.GetUnderlyingType(type).IsDateTimeType();
                    }
                    return false;
                default:
                    return false;
        ...
        /// <summary>
        /// Determines if a type is boolean.  Nullable boolean types are considered boolean.
        /// </summary>
        public static bool IsBooleanType(this Type type)
        {
            ...
            switch (Type.GetTypeCode(type))
            {
                ...
                case TypeCode.Object:
                    if (type.IsGenericType && type.GetGenericTypeDefinition() == typeof(Nullable<>))
                    {
                        return Nullable.GetUnderlyingType(type).IsBooleanType();
                    }
                    return false;
            }
            return false;
